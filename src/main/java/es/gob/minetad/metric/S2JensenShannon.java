...
public class S2JensenShannon {

    private static final Logger LOG = LoggerFactory.getLogger(S2JensenShannon.class);
    ...
    public static double similarity(double[] v1, double[] v2){
        return 1 - Math.sqrt(2*Maths.jensenShannonDivergence(v1,v2));
    }
    ...
    public static double divergence(double[] v1, double[] v2){
        return Math.sqrt(2*Maths.jensenShannonDivergence(v1,v2));
    }
