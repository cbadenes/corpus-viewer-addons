 ...
 */
public abstract class LoadTopicDocsFromLDA {

    private static final Logger LOG = LoggerFactory.getLogger(LoadTopicDocsFromLDA.class);

    private final String name;
    private final String dim;
    private final String endpoint;

    public LoadTopicDocsFromLDA(String name, String dim, String endpoint) {
        this.name       = name;
        this.dim        = dim;
