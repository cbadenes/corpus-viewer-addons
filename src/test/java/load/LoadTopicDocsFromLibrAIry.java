 ...
 */
public abstract class LoadTopicDocsFromLibrAIry {

    private static final Logger LOG = LoggerFactory.getLogger(LoadTopicDocsFromLibrAIry.class);

    private final String name;
    private final String dim;
    private final String endpoint;

    public LoadTopicDocsFromLibrAIry(String name, String dim, String endpoint) {
        this.name       = name;
        this.dim        = dim;
    ...
    public void execute() throws UnirestException, IOException, SolrServerException {
        ...
        solrQuery.setRows(0);
        solrQuery.setQuery("*:*");
        QueryResponse rsp = collection.getSolrClient().query("doctopics",solrQuery);
        ...
        while(dimIterator.hasNext()){
            ...
            solrQuery.setRows(0);
            solrQuery.setQuery("hashexpr5:t"+id);
            rsp = collection.getSolrClient().query("doctopics",solrQuery);
