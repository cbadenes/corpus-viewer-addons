 ...
 */
public abstract class LoadDocuments {
    ...
    public LoadDocuments(String corpus, Integer max, Integer offset) {
        ...
        this.numTopics  = corpus.endsWith(".csv")? Integer.valueOf(StringUtils.substringBetween(corpus,"-",".csv")) : 0;
        ...
        try {
            ...
            this.collection = new SolrCollection(name + "-documents");
        } catch (Exception e) {
