...
docker exec -it solr solr create_collection -c cordis-documents -d documents -shards 1 -replicationFactor 1
...
docker exec -it solr solr create_collection -c wikipedia-documents -d documents -shards 1  -replicationFactor 1
...
docker exec -it solr solr create_collection -c patents-documents -d documents -shards 1 -replicationFactor 1
